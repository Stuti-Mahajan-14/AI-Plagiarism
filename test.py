...
def plot_top_repeated_words(text):
    ...
    fig = px.bar(x=words, y=counts, labels={'x': 'Words', 'y': 'Counts'}, title='10 Most Repeated Words')
...
text_area = st.text_area("Or enter text here", "", height=200)

if uploaded_file is not None:
    text_area = ""
    if uploaded_file.type == "application/pdf":
        text_area = read_pdf(uploaded_file)
    elif uploaded_file.type == "application/vnd.openxmlformats-officedocument.wordprocessingml.document":
        text_area = read_docx(uploaded_file)
        ...
        if text_area.strip() == "":
            ...
            with col2:
                ...
                if isinstance(text_area, str):
                    # Text entered directly into the text area
